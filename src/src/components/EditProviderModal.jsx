...
// "Харилцагчийн бүртгэл" (/providers) хуудасны Нэмэх/Засах модаль —
// 2026-08-19 хэрэглэгчийн screenshot-оор өгсөн бүтэц (EditClientModal.jsx-
// ийн загварыг дахин ашигласан, Rule of two) + шинэ "Банк+Данс" хэсэг
// (Монголын банкны харилцахын дансны бүтэц: [Банк][IBAN#][Данс]).
const BANKS = [
  'Хаан банк',
  'Голомт банк',
