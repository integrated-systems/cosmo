...
//   ("СӨХ-ны бурхан") болон SUPERSYSADMIN ("бурхдын бурхан") ЭНЭ
...
//   БОЛОН нууц үг тохируулах эрх үргэлж зөвхүн Админ-д хамаарна,
...
// 2026-09-24: "Цалин бодолт" (payrollacc), "Харилцахын гүйлгээ"
// (transactions) хуудас цэс-ээс устгагдсан тул, тэдгээрийг ХЭРЭГЛЭДЭГ
// байсан тусгай үйлдлүүдийг БОДИТООР тухайн үйл ажиллагаа хийгддэг
// хуудас руу (цалин тооцоолол → hrm/Ажилтны бүртгэл, төлбөр бүртгэх →
// owners/clientele/property — RecordPaymentModal ашигладаг 3 хуудас)
// шилжүүлэв.
const SPECIAL_ACTIONS = [
  { key: 'calc_payroll', label: 'Сарын цалин тооцох', pages: ['hrm'] },
  ...
  { key: 'register_payment', label: 'Төлбөр бүртгэх', pages: ['owners', 'clientele', 'property'] },
];
