...
// хэрэглэгчийн заасан screenshot загварын дагуу). "Terms of Service" линк
// дарахад Modal.jsx-ийн "xl" хэмжээгээр (max 900×1200px, жижиг дэлгэцэд
// уян хатан) гэрээний текст скроллдог картаар харагдана. Чекбокс
// тэмдэглэгдээгүй бол "Бүртгүүлэх" товч идэвхгүй.
//
// 2026-09-09 (33): Гэрээний текстийг hardcode-с app_settings
// (key='terms_of_service', SUPERSYSADMIN Billing хуудаснаас гараар
// засварладаг) руу шилжүүлэв — Topbar-ийн тохиргооны цэсний "Terms
// of Services" мвртэй НЭГ л газраас (Rule of two) уншина.
export default function SignUpPage({ onBackToLogin }) {
  ...
  useEffect(() => {
    supabase.from('app_settings').select('value').eq('key', 'terms_of_service').single().then(({ data }) => {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-sidebg">
      ...
      <Modal open={showContract} onClose={() => setShowContract(false)} title="Terms of Service" size="xl">
