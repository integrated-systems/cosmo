...
export function useInvoicePayments(hoaId, targetType) {
  ...
  const paidColor = finSettings?.paid_color || 'customGreen';
  ...
  return { loading, earliestYear, getYearSummary, getMonthStatus, overdueColor, atRiskColor, pendingColor, paidColor };
}
